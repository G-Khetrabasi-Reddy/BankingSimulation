...
class TransactionControllerTest {
    ...
    void testPerformTransfer_Success() {
        ...
        when(transactionService.transferMoney(anyString(), anyString(), anyDouble(), anyString(), anyString()))
    ...
    void testPerformTransfer_InvalidAmount() {
        ...
        when(transactionService.transferMoney(
                anyString(), anyString(), eq(-100.0), anyString(), anyString()))
    ...
    void testPerformTransfer_MissingReceiverAccount() {
        ...
        when(transactionService.transferMoney(
                anyString(), isNull(), anyDouble(), anyString(), anyString()))
    ...
    void testPerformTransfer_MissingSenderAccount() {
        ...
        when(transactionService.transferMoney(
                eq(""), anyString(), anyDouble(), anyString(), anyString()))
