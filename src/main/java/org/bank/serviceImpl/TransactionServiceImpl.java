...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public Optional<Transaction> transferMoney(String senderAccountNumber, String receiverAccountNumber, double amount, String description, String transactionMode) {
        // Validation
